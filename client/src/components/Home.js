...
function Home(props) {
  ...
  const [announcements, setAnnouncements] = useState([
    {title: "The Magic Toy Box", blurb: "A week-long half-day camp for kids ages 4 - 6. Beloved teaching artist at The Flynn and schools across Vermont, Tracy Martin takes children on a joyful journey of movement, storytelling and performance made for and by kids. Siblings welcome! $100. Scholarships available!", time: "Monday, June 17 - Friday, June 21 9a - noon"},
    {title: "Art and the Discomfort Zone", blurb: "A five-week seminar focused on art that challenges cultural norms about what is “pretty” to spur creative growth. Former instructor at the Art Institute of California, Pim Volpi, takes participants through various artistic movements, culminating in making pieces inspired by the concepts presented. Open to young adults & up. $100. Scholarships available!", time: "Saturdays, July 6, 2024 through August 3, 2024 10a - 1p"},
    {title: "Family Nature Hunts", blurb: "Renowned author and naturalist, Clare Walker Leslie, leads two fun and informative sessions that help us see and record the wild world all around us. You’ll be amazed at how many critters and plants make their home near the schoolhouse and how their lives are connected to our own! $10 suggested donation per family. Everybody's welcome!", time: "Thursday, July 18, 2024 10a - noon & Wednesday, Aug 7, 2024 4p -6p"},
    {title: "Memoir Writing", blurb: "Discover why we should tell our own stories and the best forms for doing so, both for an audience and personal enrichment. Award winning writer/educator Kate Youngdahl-Stauss, whose work has appeared on PBS, History and National Geographic, leads a five part course for young adults through super seniors. $100. Scholarships available.", time: "Thursdays, July 11, 2024 through August 8, 2024 5p - 7p"}
  ]);
